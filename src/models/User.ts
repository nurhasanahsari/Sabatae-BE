...
export default class Users {
  public static getTableUsers = (param?: IUserParam): Promise<IResM> => {
  ...
  public static getUserCountSummary = (param?: IUserParam): Promise<IResM> => {
    return new Promise((resolve, reject) => {
      try {
        const sqlParams: String[] = [];

        let qs = 'select role, count(role) from sc_main.t_user tu group by role order by role';
  ...
  public static getUserInfo = (param?: IUserParam): Promise<IResM> => {
    return new Promise((resolve, reject) => {
      try {
        const sqlParams: String[] = [];
